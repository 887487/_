...
PC1で作成したデータをPC2でも閲覧可能な設計にしてください
* ファイルが見つかりません（ID: smf_1777869879886_k6k2om）
* ヘッダーのスクリプトを押下するとindex.htmlがひらく→script.htmlを開くように修正してください。
* スクリプトの表に対して文字の左/中央/右揃えを可能にしてください
* スクリプト/メール/画面遷移/ヒアリング/サイドメニュー/更新履歴　のデータを更新した時、別PCでもページ更新で自動反映にできますか？
* エクスポートしたファイルの中身が完全ではない
* 
* 
