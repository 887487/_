...
* フォネティックコード/ショートカットキー　表内の文字編集時、キー入力の度にフォーカス解除されてしまう
...
admin.html ヒアリングタブ
* トグルボタンの追加方式に　デバイスと詳細　の方式を採用する（デバイスと詳細 は削除する）

admin.html サイドメニュータブ
* サイドメニューのドメインリスト　と　ヒアリングシートのドメインリスト（@docomo.ne.jp/@softbank.ne.jp/@i.softbank.jp/@ezweb.ne.jp/@au.com/@gmail.com/@yahoo.co.jp/@icloud.com/@outlook.com/その他(手入力)）　は別にしてください
