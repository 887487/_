...
window.DEFAULT_SIDE_MENU_DATA = [
  { id: 'linkTools', label: '🔧 ツール', type: 'links', items: [
    { name: 'Genesys',         url: 'https://login.mypurecloud.jp/#/authenticate-adv/org/tci-gp1',   manualUrl: '' },
    { name: 'CRM',             url: 'https://ctssvr501.cloud.contact-link.jp/cts_nhk_net/login/index.php', manualUrl: '' },
    { name: 'LINE WORKS',      url: 'https://auth.worksmobile.com/login/login?accessUrl=https%3A%2F%2Fcommon.worksmobile.com%2Fproxy%2Fmy', manualUrl: '' },
    { name: '対話要約AI',      url: 'https://tci-dcc-support-summaryai02.spiral-site.com/summary_nhk', manualUrl: '' },
    { name: 'SpeechVisualizer',url: 'http://tci-ami-web16/Speechvisualizer/', manualUrl: '' }
  ]},
